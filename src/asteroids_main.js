...
var g_bombAudio = null;
var g_laserAudio = null;
...
function onloadHandler()
{
   ...
   /*if (Game.hasAudio())
   {
      g_bombAudio = new Audio();
      g_bombAudio.src = 'sounds/bomb.mp3';
      g_laserAudio = new Audio();
      g_laserAudio.src = 'sounds/laser.mp3';
   }*/
